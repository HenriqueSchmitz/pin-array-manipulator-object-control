...
def train():
    ...
    trainer = ResidualGeneticTrainer(env, ResidualTargetNetwork, population_size=50, elite_size=5)
    ...
    for gen in range(generations):
        ...
        if gen % 10 == 0:
            torch.save(trainer.population[0], f"./models/best_residual_model_gen_{gen}.pt")
    torch.save(trainer.population[0], "./models/final_residual_model.pt")
